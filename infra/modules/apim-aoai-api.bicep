...
// GitHub Copilot CLI BYOK ('azure' mode) speaks the OpenAI-style /v1/* surface:
// it POSTs to /v1/chat/completions with the model/deployment in the request BODY,
// NOT in the URL. The policy rewrites these to the Azure OpenAI deployment-scoped
// data-plane path (/openai/deployments/{model}/...) the backend expects.
